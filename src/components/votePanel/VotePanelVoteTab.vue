...
<template>
  <section class="mt-4 space-y-3 border-t border-white/10 pt-4">
    ...
    <label class="block text-xs text-zinc-400">
      {{ vp.t('votePanel.evidenceUrlLabel') }}<span v-if="vp.requiresEvidenceUrl.value" class="text-amber-200"> *</span>
      <input
    ...
    <label class="block text-xs text-zinc-400">
      {{ vp.t('votePanel.evidenceNoteLabel') }}<span v-if="vp.requiresEvidenceNote.value" class="text-amber-200"> *</span>
      <textarea
        ...
        :disabled="!vp.isVotingOpen.value"
        :placeholder="vp.requiresEvidenceNote.value ? vp.t('votePanel.evidenceNoteRequired') : vp.t('votePanel.optional')"
      ></textarea>
    </label>
