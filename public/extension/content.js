...
const FALLBACK_DOMAIN_CONFIGS = [
  ...
  { domain: 'nextapple.com', article_url_pattern: '^/(?:realtime|local|politics|life|entertainment|international|finance|sports)/', blocked_path_pattern: DEFAULT_BLOCKED_PATH_PATTERN },
