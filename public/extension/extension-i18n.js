const dictionaries = {
  'zh-TW': {
    ...
    authSignedIn: '已登入',
    authSignedOut: '尚未登入',
    authHint: '如果你已在官網登入，插件會自動同步。',
    authOpenHub: '開啟官網登入後，回到新聞頁即可使用同一個身份。',
    loading: '讀取中...',
    openStatus: '查看目前頁面評分',
    openVote: '開啟投票與證據面板',
  ...
  en: {
    ...
    authHint: 'If you signed in on the website, the extension syncs automatically.',
    authOpenHub: 'Open the website and sign in, then return to the article with the same identity.',
    loading: 'Loading...',
